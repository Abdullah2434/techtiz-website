export const ESCONDIDO_CASE_STUDY = {
  ...
  seo: {
    title: 'City of Escondido · Geotechnical & Special Inspection (RFP No. 26-19) | Techtiz SLED',
    description:
  ...
  facts: [
    { key: 'Solicitation', value: 'RFP No. 26-19', sub: 'As-needed, task-order' },
    { key: 'Scope', value: 'Utilities CIP', sub: 'Geotech & special inspection' },
  ...
  keyDates: {
    ...
    events: [
      { date: 'May 21, 2026', label: 'Published', detail: 'RFP No. 26-19 released' },
      { date: 'Jun 12, 2026', label: 'Questions due', detail: '2:00 PM PDT' },
      { date: 'Jun 15, 2026', label: 'Answers posted', detail: 'City responds to questions' },
      { date: 'Jun 18, 2026', label: 'Proposals due, 2 PM PDT', detail: 'Single email. No late acceptance', hard: true },
      { date: 'Jun 22 to 26', label: 'Staff review', detail: 'City evaluates proposals' },
      { date: '~Jul 10, 2026', label: 'Award', detail: 'Council or designee approves' },
    ],
    foot: {
  ...
  awardModel: {
    ...
    rows: [
      ...
      {
        label: 'Rates',
        value: 'Fixed for the term once submitted. There is no adjustment mechanism without a written amendment.',
      },
    ],
  },
  taskAllocation: {
  ...
  pricing: {
    ...
    scenarios: [
      { tier: 'Low', value: '$75', unit: '/ hr field tech', detail: 'Special inspector $80, PE $145.' },
      { tier: 'Mid', value: '$85', unit: '/ hr field tech', detail: 'Special inspector $90, PE $160, PM $175.', recommended: true, pill: 'Recommended' },
      { tier: 'High', value: '$100', unit: '/ hr field tech', detail: 'Special inspector $110, PE $185.' },
    ],
    footnotes: [
      {
        icon: 'info',
  ...
  securityGrid: {
    ...
    items: [
      { icon: 'gavel', title: 'California law, SD venue', desc: 'San Diego County courts. Government Claims Act applies.' },
      { icon: 'hard-hat', title: 'Prevailing wages & DIR', desc: 'Labor Code 1720, 1770; DIR registration under 1725.5.' },
      { icon: 'badge-check', title: 'IRCA', desc: 'Work-authorization compliance for all staff.' },
      { icon: 'building', title: 'CBC Chapter 17', desc: 'Governs special inspection on this work.' },
      { icon: 'droplets', title: 'RWQCB storm-water permit', desc: 'Order R9-2013-0001, through the indemnification clause.' },
      { icon: 'tags', title: 'Buyer\'s NIGP codes', desc: '92546, 92550, 92532, 95826, 91275.' },
    ],
  },
  agency: {
    eyebrow: 'Agency context',
    heading: 'Who is buying, and why.',
    photo: 'https://upload.wikimedia.org/wikipedia/commons/e/e5/Mark_Skovorodko_Photography_-_Escondido_City_Hall.jpg',
    ...
    attribution: 'Escondido City Hall. Photo: Mark Skovorodko, CC BY-SA 4.0, via Wikimedia Commons.',
  },
  competingField: {
    ...
    stats: [
      ...
      { value: '16', valueSuffix: '/ 31', label: 'Highly / partially relevant' },
    ...
    bar: {
      ...
      legends: [
        { tier: 'nat', count: '10', label: 'national, $100M+, where the revenue concentrates' },
  ...
  techtizApproach: {
    ...
    liveOnly: true,
    cards: [
      { title: 'NDA before any data', body: 'A mutual NDA and written City consent before a single City document moves.' },
      { title: 'Pre-award package', body: 'Executive summary, references, resumes, and rate schedule, assembled for your review.' },
      { title: 'Post-award paperwork', body: 'RFI drafts, daily reports, and test-report formatting, after your licensed staff certify.' },
      { title: 'Your firm owns the field', body: 'All on-site work, certification, signatures, and City communication stay with the prime.' },
    ],
    lockedNote: 'Prime name, engagement value, and City data stay under NDA. Techtiz never contacts the City.',
  },
  cta: {
    eyebrow: {

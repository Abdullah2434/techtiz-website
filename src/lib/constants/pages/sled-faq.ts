...
export const PROCUREMENT_VEHICLES_FAQ: SledFaqContent = {
  ...
  intro:
    "How Techtiz joins pursuits on NASPO, GSA, state masters, cooperatives, and direct subcontract vehicles.",
  items: [
    {
    ...
    },
    {
      ...
      answer:
        "Yes. We accept prime flow-down terms consistent with subcontractor performance, including security, IP, insurance, and data-handling clauses in your master subcontract template.",
    },
  ],
} as const;
...
export const CASE_STUDIES_FAQ: SledFaqContent = {
  ...
  intro:
    "Why case narratives are summarized and how to request detail under NDA.",
  items: [
    {
    ...
    },
    {
      ...
      answer:
        "Examples include GIS and statutory environmental submissions, statewide portal accessibility remediation, permitting platform integration, and grant reporting workstreams. Each is delivered as a subcontracted technical slice under a prime's vehicle.",
    },
    {
...
export const CAPABILITY_STATEMENT_FAQ: SledFaqContent = {
  ...
  intro:
    "How to use this one-page statement in capture and subcontract onboarding.",
  items: [
    {
      question: "What is the Techtiz capability statement used for?",
      answer:
        "It is a prime-facing snapshot of core competencies, differentiators, compliance posture, and teaming contact for subcontract onboarding packets, capture folders, and BD introductions before deeper NDA conversations.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "541511 and 541512 for custom computer programming and computer systems design services, plus state NIGP 918-46 and 918-00 where state procurement applies.",
    },
    {

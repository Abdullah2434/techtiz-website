...
export const TRUST_CLIENTS = [
  ...
  { name: 'Capsule Lab', alt: false },
  { name: 'Northstar Health', alt: true },
  { name: 'Meridian Logix', alt: false },
  { name: 'Orbital Studio', alt: true },
] as const;

export const CAPABILITIES = [
  {
    title: 'Development',
    desc: 'Production-grade web, mobile, and platform engineering. Sketch to scale, with the same team across the whole arc.',
    tags: ['Web', 'Mobile', 'APIs', 'Cloud'],
  ...
  },
  {
    ...
    desc: 'LLM systems, RAG, agents, and ML pipelines that ship and stay in production. Instrumented, evaluated, cost-controlled.',
    tags: ['Agents', 'RAG', 'Fine-tuning', 'Evals'],
    stack: 'Anthropic · OpenAI · LangGraph · Pinecone · pgvector · Modal · Inngest',
  ...
  {
    title: 'Automation & AI',
    desc: 'Internal tools and workflows that pay for themselves. Lead-gen, ops, support, billing, every flow that drains a Tuesday.',
  ...
  },
  {
    ...
    desc: 'Modernize legacy stacks without halting the business. Strategy, migrations, data, operations, change management.',
    tags: ['Strategy', 'Migrations', 'Data', 'Ops'],
  ...
  {
    title: 'UX Design',
    desc: 'Research-backed interfaces that feel inevitable. Systems, prototyping, brand, and the unglamorous edge cases.',
  ...
  {
    title: 'Data & Platform',
    desc: 'Warehouses, lakehouses, and the pipelines that feed AI in production. Observability built in, not bolted on.',
...
> = {
  healthcare: {
    ...
    challenges: [
      { title: 'Admin overhead steals clinical hours', pain: 'Charting, scheduling, and billing eat the day before a single patient is seen.' },
      { title: 'Patient data scattered across systems', pain: 'EMR, scheduling, and lab portals never talk; nurses become integration code.' },
      { title: '24/7 support without staffing the night shift', pain: 'Patient inquiries hit at 2am; phone trees are a liability, not a service.' },
    ],
    cta: 'Talk to a healthcare specialist.',
    ctaSub: "A 30-minute scoping call, NDA-first, with the engineer who would lead delivery.",
  },
  marketing: {
    icon: 'growth',
    ...
    challenges: [
      { title: 'Attribution data lives in 8 dashboards', pain: 'Stitching channels by hand burns analyst hours; signal arrives a week late.' },
      { title: 'Manual reporting eats the analyst', pain: 'CSV exports, deck builds, screenshots; the actual analysis ships on Friday.' },
      { title: 'Performance drift goes unnoticed', pain: 'Campaigns decay slowly; no one is watching the right metric on the right day.' },
    ],
    cta: 'Talk to a growth specialist.',
    ctaSub: 'A 30-minute scoping call with the engineer who would build your attribution stack.',
  },
  realestate: {
    icon: 'house',
    ...
    challenges: [
      { title: 'Listings out-of-sync across portals', pain: 'MLS, Zillow, your site, and the brokerage CRM all show different prices.' },
      { title: 'Lead routing leaks on the weekend', pain: 'Inquiries land Saturday at 11pm; on Monday the lead is cold or already with a competitor.' },
      { title: 'Valuation models drift on stale data', pain: 'Predictions trained six months ago no longer match the neighborhood.' },
    ],
    cta: 'Talk to a real-estate specialist.',
    ctaSub: 'A 30-minute scoping call with the engineer who would lead delivery.',
  },
  ecommerce: {
    icon: 'cart',
    ...
    challenges: [
      { title: 'Headless migration without breaking SEO', pain: 'Replatforming loses the catalog rank you spent two years earning.' },
      { title: 'Inventory drift across channels', pain: 'Shopify, Amazon, retail POS each tell a different story about the same SKU.' },
      { title: 'Checkout drops on slow PDPs', pain: 'Page weight, third-party scripts, and image bloat cut conversion before the cart loads.' },
    ],
  ...
  logistics: {
    ...
    challenges: [
      { title: 'Routing static across volatile fuel costs', pain: 'Plans built Monday no longer pencil by Wednesday; margin disappears mid-route.' },
      { title: 'WMS and TMS speak different dialects', pain: 'Inventory and transport ship blind to each other; cross-dock waits get expensive fast.' },
      { title: 'Carrier visibility gaps in last-mile', pain: 'You see the truck leave, you see it deliver, you see nothing in between.' },
    ],
  ...
  education: {
    ...
    challenges: [
      { title: 'Engagement drops mid-cohort', pain: 'Week 4 is the cliff; nobody sees the at-risk learner until grades post.' },
      { title: 'Accessibility retrofits ship late', pain: 'WCAG audits arrive 30 days before launch; remediation eats the runway.' },
      { title: 'Assessment data silos by department', pain: 'Reading, math, and SEL each in their own platform; no joined-up student view.' },
    ],
...
export const WHY_TABS = [
  { id: 'expert', num: '01', title: 'Expert Team', tag: 'Senior-led delivery at every stage' },
  { id: 'ontime', num: '02', title: 'On-Time Delivery', tag: 'Predictable timelines, zero surprises' },
  { id: 'scalable', num: '03', title: 'Scalable Solutions', tag: 'Built to grow, not to rewrite' },
  { id: 'ongoing', num: '04', title: 'Ongoing Support', tag: "We don't disappear after launch" },
] as const;
...
export const CASE_STUDIES = [
  {
    ...
    solution: 'Unified marketplace plus a booking SDK with realtime supply sync.',
  ...
  },
  {
    ...
    solution: 'Lakehouse plus an LLM-driven exploration UI on top of curated sets.',

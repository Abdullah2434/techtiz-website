export const ALTADENA_CASE_STUDY = {
  ...
  seo: {
    title: 'Altadena Library District · Accounting Services (RFP No. 31) | Techtiz SLED',
    description:
  ...
  hero: {
    ...
    ctas: [
      { label: 'Start an NDA conversation', href: '/us-sled/contact/', variant: 'ghost-dark' },
      { label: 'All engagement examples', href: '/us-sled/case-studies/', variant: 'cyan' },
    ],
  },
  facts: [
    ...
    { key: 'Techtiz role', value: 'Back-office', sub: 'NDA-first, never agency-facing' },
  ],
  competingField: {
    ...
    stats: [
      ...
      { value: '~$2.7', valueSuffix: 'B', label: 'Combined revenue, mostly two national firms' },
    ],
    bar: {
      segments: [
        { tier: 'nat', width: 10 },
      ...
      legends: [
        { tier: 'nat', count: '2', label: 'national, $100M+ (Baker Tilly ~$1.8B, Eide Bailly ~$761M)' },
  ...
  keyDates: {
    ...
    events: [
      { date: 'May 19, 2026', label: 'RFP issued', detail: 'RFP No. 31 released' },
      { date: 'Jun 19, 2026', label: 'Questions due', detail: 'By 5:00 PM, to the District' },
      { date: 'Jun 22, 2026', label: 'Answers posted', detail: 'District responds to questions' },
      { date: 'Jun 26, 2026', label: 'Proposals due, 5:00 PM PT', detail: 'Electronic only. No late acceptance', hard: true },
      { date: 'Jun 29 to Jul 3', label: 'Evaluation', detail: 'District reviews proposals' },
      { date: 'Week of Jul 6', label: 'Optional interview', detail: 'One hour, in person or virtual' },
      { date: 'Jul 20, 2026', label: 'Board selection', detail: 'Trustees approve the award' },
      { date: 'Aug 3, 2026', label: 'Tentative start', detail: 'Agreement returned in 10 working days' },
    ],
    foot: {
  ...
  taskAllocation: {
    ...
    heading: 'What a remote back-office can run, and what cannot leave the prime.',
  ...
  capabilityGrid: {
    ...
    items: [
      { icon: 'building-2', title: 'California government clients', desc: 'A list of California government agency clients.' },
      { icon: 'receipt', title: 'IRS and EDD knowledge', desc: 'Knowledge of IRS taxation and California EDD law.' },
      { icon: 'book-check', title: 'GASB implementation', desc: 'Experience implementing GASB pronouncements.' },
      { icon: 'users', title: 'CalPERS reporting', desc: 'Reporting employee retirement and health data to CalPERS.' },
    ],
  },
  evaluation: {
    ...
    cards: [
      {
        ...
        items: [
          { type: 'num' as const, num: '1', text: '<strong>Qualitative review</strong> against the factors at right. No numeric weights, award at the District\'s discretion.' },
          { type: 'num' as const, num: '2', text: '<strong>Two-person approval.</strong> The District Director signs, General Counsel approves as to form, the Board confirms on July 20.' },
          { type: 'num' as const, num: '3', text: '<strong>Optional interview,</strong> one hour, led by a principal, in the week of July 6. Treat it as the close.' },
        ],
      },
      {
        title: 'What they weigh',
        items: [
          { type: 'icon' as const, icon: 'briefcase', text: '<strong>Experience & References.</strong> Comparable California public-sector work, three external references.' },
          { type: 'icon' as const, icon: 'user-round', text: '<strong>Personnel.</strong> Resumes, a named relationship manager, a named computer financial analysis specialist.' },
          { type: 'icon' as const, icon: 'target', text: '<strong>Proposer Qualifications.</strong> Demonstrated understanding of this specific district.' },
          { type: 'icon' as const, icon: 'calculator', text: '<strong>Total Cost.</strong> Fixed monthly fee for Years 1, 2, 3 plus an additional-services rate card with a not-to-exceed cap.' },
          { type: 'icon' as const, icon: 'scale', text: '<strong>Non-Discrimination.</strong> EEO and any MWBE status.' },
        ],
      },
    ],
  },
  pricing: {
    ...
    scenarios: [
      { tier: 'Low', value: '$7,500', unit: '/ mo', detail: 'About $90,000 per year.' },
      { tier: 'Mid', value: '$10,500', unit: '/ mo', detail: 'About $126,000 per year.', recommended: true, pill: 'Recommended' },
      { tier: 'High', value: '$13,500', unit: '/ mo', detail: 'About $162,000 per year.' },
    ],
    footnotes: [
      {
        icon: 'alert-triangle',
  ...
  securityGrid: {
    ...
    risks: [
      { icon: 'server-crash', title: 'Portal failure', text: 'Congestion or an outage on deadline day. Submit early, not at 4:59.' },
      { icon: 'file-warning', title: 'Insurance conflict', text: 'Leaving the $1M vs $2M gap unresolved past June 19.' },
      { icon: 'user-x', title: 'Key-employee availability', text: 'The named lead must hold across a multi-year term.' },
      { icon: 'phone-off', title: 'Weak references', text: 'They are called before the Board date. Confirm them.' },
      { icon: 'landmark', title: 'CFD understaffing', text: 'Mello-Roos tracking needs a named owner, not a footnote.' },
      { icon: 'globe-lock', title: 'Unapproved offshore use', text: 'Any offshore work without written approval and an NDA.' },
    ],
  },
  strategicQuestions: {
    eyebrow: 'Before you submit',
    ...
    questions: [
      ...
      {
        num: 'Question 02',
        title: 'Is a US-prime-supervised remote support team under NDA permitted?',
  ...
  techtizApproach: {
    ...
    liveOnly: true,
    cards: [
      { title: 'NDA before any data', body: 'A mutual NDA and written District approval before a single record moves.' },
      { title: 'Drafts, you sign', body: 'We build models, reconciliations, and statement drafts. Your CPA reviews and signs.' },
      { title: 'Your firm faces the District', body: 'All communication, filings, and Board attendance stay with the prime.' },
      { title: 'CFD bond fluency', body: 'Mello-Roos proceeds tracking reconciled to US Bank, prepared for your review.' },
    ],
    lockedNote: 'Prime name, engagement value, and District data stay under NDA. We never contact the District.',
  },
  cta: {
    eyebrow: {
    ...
    buttons: [
      { label: 'Start an NDA conversation', href: '/us-sled/contact/', variant: 'cyan' },
      { label: 'See capabilities & compliance', href: '/us-sled/capabilities/', variant: 'ghost' },
    ],
  },
} as const;

export const HOLLAND_CASE_STUDY = {
  ...
  seo: {
    title: 'City of Holland · Cloud-Delivered SASE (Ref 0000426310) | Techtiz SLED',
    description:
  ...
  facts: [
    { key: 'Solicitation', value: 'Ref 0000426310', small: 'Cloud-Delivered SASE, sealed' },
    { key: 'Scope', value: 'Security Service Edge', small: 'Cloud-native, no appliances' },
    { key: 'Award', value: 'Single vendor', small: 'New contract, lump sum' },
    { key: 'Techtiz role', value: 'Back-office', small: 'NDA-first, never agency-facing' },
  ],
  keyDates: {
    modHead: {
    ...
    events: [
      { date: 'Jun 2, 2026', label: 'Published', detail: 'Solicitation issued, 7:13 AM EDT' },
      { date: 'Jun 15, 2026', label: 'Questions due, 12 noon EDT', detail: 'Written, to Joe Firmiss only. Phone calls not accepted' },
      { date: 'After Jun 15', label: 'Q&A posted', detail: 'To cityofholland.com. No fixed release date stated' },
      {
        date: 'Jun 22, 2026',
  ...
  evaluation: {
    ...
    bars: [
      ...
      { label: 'B Experience & capacity of respondent and staff', pct: '~30%', width: 30 },
      { label: 'C Quality & methodology of insurance placement program', pct: '~20%', width: 20 },
  ...
  competingField: {
    ...
    legends: [
      { variant: 'nat', count: '8', label: 'national, $1B+, where the revenue concentrates' },
  ...
  response: {
    ...
    chips: [
      ...
      { num: '07', text: 'Security certifications, SOC 2 Type II, ISO 27001, FedRAMP if applicable' },

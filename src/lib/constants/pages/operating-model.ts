export const OPERATING_MODEL_SEO = {
  ...
  description: "Techtiz's onshore-controlled, offshore-engineered SLED operating model: CONUS/Lahore air-gapped data architecture, CJIS/CUI/FCI/FTI handling, background-checked US personnel, and per-state offshore restrictions.",
...
export const ONSHORE_DATA_CLASSES = ['CUI', 'FCI', 'CJI', 'PHI', 'Agency PII', 'Live production data'] as const;
...
export const OFFSHORE_DATA_CLASSES = ['Synthetic data', 'Mock fixtures', 'Public-domain artifacts', 'Codebase & configs'] as const;
...
export const DISCLOSURE_STEPS = [
  { n: 'Step 01', heading: 'Operating-model pack on first NDA call.', body: 'Architecture diagram, data-class matrix, framework status sheet, and per-state posture page delivered with the NDA.' },
  { n: 'Step 02', heading: 'Data-flow analysis with the prime.', body: "Joint review of where the engagement's data falls on the matrix. Onshore-only vs. bifurcated scopes labelled before any technical conversation." },
  { n: 'Step 03', heading: 'State-specific disclosure drafted.', body: "For each target state on the bid, the disclosure language the prime would file with the agency, drafted for the prime's review." },
  { n: 'Step 04', heading: 'Flow-down clause mapping.', body: 'Every clause that flows down from the prime contract is mapped to a specific Techtiz control or attestation. Gaps surfaced before subcontract signature.' },
  { n: 'Step 05', heading: 'Personnel attestation file.', body: 'Named-personnel attestations for any onshore-required work, citizenship and clearance status, delivered as a sealed file to the prime.' },
  { n: 'Step 06', heading: 'Continuous-compliance reporting.', body: 'Quarterly attestations to the prime PMO. Annual joint controls review. Incident-response runbook with prime + Techtiz contacts.' },
] as const;

export const MDC_CASE_STUDY = {
  ...
  seo: {
    title: 'Miami Dade College · Professional Engineering Services (RFQ 2026-WP-15) | Techtiz SLED',
    description:
  ...
  facts: [
    { key: 'Solicitation', value: 'RFQ 2026-WP-15', small: 'Qualifications-based' },
    { key: 'Codes', value: 'NAICS 541330', small: 'NIGP 90735 · 90700' },
    { key: 'Structure', value: 'Two on-call pools', small: 'Six disciplines' },
    { key: 'Techtiz role', value: 'Back-office', small: 'White-label, under NDA' },
  ],
  awardModel: {
    modHead: {
  ...
  keyDates: {
    ...
    events: [
      { date: 'May 21, 2026', label: 'RFQ issued', detail: 'Solicitation 2026-WP-15 released' },
      {
        date: 'May 29, 2026',
        label: 'Questions due',
      ...
      { date: 'Jul 2026', label: 'Board approval', detail: 'Board of Trustees expected to approve selections' },
      {
        date: 'Aug 1, 2026',
        label: 'Contract commences',
        detail: 'Initial term through Jun 30, 2027, plus two 1-year options',
      },
      { date: '90 days', label: 'Irrevocable', detail: 'Proposals stay firm for 90 days after opening' },
    ],
  },
  differentiator: {
    mark: '\u201C',
  ...
  securityGrid: {
    ...
    items: [
      { icon: 'hard-hat', title: 'Davis-Bacon prevailing wage', desc: 'Construction over $2,000' },
      { icon: 'users', title: 'Equal Employment Opportunity', desc: 'EEO obligations on covered work' },
      { icon: 'megaphone-off', title: 'Byrd Anti-Lobbying', desc: 'Certification required' },
      { icon: 'search-check', title: 'SAM debarment checks', desc: 'Active registration and screening' },
      { icon: 'clock', title: 'Contract Work Hours & Safety', desc: 'Construction over $100,000' },
      { icon: 'package', title: 'Domestic material preference', desc: '2 CFR 200.322' },
      { icon: 'wind', title: 'Clean Air and Water Act', desc: 'Projects over $150,000' },
    ],
  },
  capabilityGrid: {
    modHead: {

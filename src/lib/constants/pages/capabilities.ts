export const CAPABILITIES_SEO = {
  ...
  description: "The Techtiz SLED backbone: specialized engineering capabilities, technology stack, compliance frameworks, and clear delivery boundaries for U.S. public-sector prime contractors.",
...
export const CAPABILITY_MATRIX = [
  {
    ...
    tools: 'Custom rule engines · Statutory framework libraries · EGLE guidance maps',
  },
  {
  ...
  },
  {
    ...
    tools: 'Custom survey platforms · Accessibility tooling · i18n stacks · Plain-language pipelines',
  },
  {
  ...
  },
  {
    ...
    tools: 'axe DevTools · Screen-reader testing (NVDA, VoiceOver) · Plain-language style guides',
  },
  {
    ...
    tools: 'Project management instrumentation · Notion · Linear · Custom deadline alerting',
  },
  {
    ...
    tools: 'Custom audit logging · Structured records export · S3 immutable storage',
  },
] as const;
...
export const TECH_STACK = [
  {
    ...
    tools: ['ArcGIS Pro', 'ArcGIS Online', 'PostGIS', 'GeoPandas', 'Mapbox', 'Leaflet', 'QGIS', 'Turf.js'],
  },
  {
    heading: 'Engagement & Automation',
    subLabel: 'Public-facing workflows',
    tools: ['Make.com', 'n8n', 'Zapier', 'Custom survey platforms', 'SurveyMonkey API', 'Twilio', 'SendGrid', 'i18next'],
  },
  {
    heading: 'Docs & Publishing',
    subLabel: 'Statutory-format deliverables',
    tools: ['Adobe InDesign', 'Adobe Acrobat Pro', 'Microsoft Office', 'PDF/UA', 'LaTeX', 'Pandoc', 'Word XML'],
  },
  {
    heading: 'Data & Reporting',
    subLabel: 'Audit, grant, compliance',
    tools: ['PostgreSQL', 'Supabase', 'Metabase', 'DuckDB', 'dbt', 'Airbyte', 'Workday Adaptive', 'S3'],
  },
] as const;

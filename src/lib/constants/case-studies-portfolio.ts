...
export const CASE_STUDIES_PORTFOLIO: CaseStudy[] = [
  ...
  },
  {
    ...
    client: "Curetrax",
    appLogo: "/images/case-studies/c5-logo.png",
    category: "Mobile App",
    image: "/images/case-studies/c5-bg.png",
    website: "",
    overview:
      "Curetrax is a telehealth and remote patient monitoring platform tailored for individuals recovering from blood cancer treatments—such as immunotherapy, CAR-T cell, and stem-cell transplants.",
    overview2:
      "It enables continuous symptom reporting and biometric tracking through a mobile app (“CuretraxAllo” / “CuretraxCAR19”) that feeds real-time data to clinical care teams. This empowers early intervention, faster hospital discharge, and more efficient home-based care.",
    tagline:
      "24/7 remote monitoring keeps clinicians updated with wearable data. Symptom tracking focuses on blood cancer side effects like headaches. Multilingual support enhances accessibility.",
    metrics: [
      { label: "Installations", value: "5k+" },
      { label: "On-time Rate", value: "92%" },
      { label: "Avg. driver response time", value: "4 Minutes" },
    ...
    highlights: [
      "Enable treatment at home, enabling faster discharge and freeing hospital capacity.",
      "Condition-specific remote care transforms provider oversight from reactive to proactive.",
      "Scalable platform ethos: Modular structure supports rapid deployment.",
    ],
    technologies: [
      { name: "React Native", icon: "/images/tech-icons/react.png" },
      { name: "Next.js", icon: "/images/tech-icons/next.png" },
  ...
  },
  {
    ...
    //   { label: "Mobility", value: "Clinician mobile app" },
    // ],
    appStrengths: [
      "Treatment-specific monitoring addresses post-transplant risks.",
      "Real-time alerting enables expedited clinical response.",
      "Supports multilingual use, suiting global deployments.",
      "Clinician mobility via mobile app improves workflow flexibility.",
    ],
    highlights: [
